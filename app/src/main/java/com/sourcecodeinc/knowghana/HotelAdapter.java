...
public class HotelAdapter extends ArrayAdapter<ItemsOnListView> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.hotel_layout, parent,
                    false);
            ...
            TextView ratingTextView = convertView.findViewById(R.id.rating_text_view);
            ratingTextView.setText(currentItem.getRatings());
            ratingTextView.setTextSize(18);

            ImageView hotelImageView = convertView.findViewById(R.id.hotel_image);
